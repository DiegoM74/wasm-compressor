...
self.onmessage = function (e) {
  ...
  const lambda_log_scale1_x100         = e.data.lambda_log_scale1         != null
    ? Math.round(e.data.lambda_log_scale1 * 100) : -1;
  const lambda_log_scale2_x100         = e.data.lambda_log_scale2         != null
    ? Math.round(e.data.lambda_log_scale2 * 100) : -1;
  const trellis_delta_dc_weight_x100   = e.data.trellis_delta_dc_weight   != null
    ? Math.round(e.data.trellis_delta_dc_weight * 100) : -1;
  // ────────────────────────────────────────────────────────────────────────
  ...
  try {
    ...
    const outputBuffer = new Uint8Array(heapAfter.slice(dataPtr, dataPtr + size));
